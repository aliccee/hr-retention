...
```{r}
replace_multiplier <- 2.5 # Cost in multiple of annual salary to replace an employee
intervention_cost <- 100  # Cost in dollars per person for retention program
success_rate <- .30       # Estimate success rate of retention program
```
